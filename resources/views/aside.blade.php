        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-car"></i><a href="/view-car">Cars</a></li>
                        <li><i class="fa fa-bus"></i><a href="/view-carmodel">Car Models</a></li>
                        <li><i class="fa fa-wheelchair-alt"></i><a href="/view-driver">Drivers</a></li>
                        <li><i class="fa fa-users"></i><a href="/view-customer">Customers</a></li>
                        <li><i class="fa fa-address-book"></i><a href="/view-booking">Bookings</a></li>
                    </ul>
                </li>
                <li class="menu-item-has-children dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        ...
                        <li><i class="menu-icon fa fa-paper-plane"></i><a href="/password/reset">Forget Pass</a></li>
                    </ul>
                </li>
            </ul>
        </div><!-- /.navbar-collapse -->
