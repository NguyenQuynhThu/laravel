        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-car"></i><a href="/view-car">Car</a></li>
                        <li><i class="fa fa-bus"></i><a href="/view-carmodel">Car Model</a></li>
                        <li><i class="fa fa-wheelchair-alt"></i><a href="/view-driver">Driver</a></li>
                        <li><i class="fa fa-users"></i><a href="/view-customer">Customer</a></li>
                        <li><i class="fa fa-address-book"></i><a href="/view-booking">Booking</a></li>
                    </ul>
                </li>
                <li class="menu-item-has-children dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
